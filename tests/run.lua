-- Minimal busted-compatible test runner. Use this when lua-busted is not
-- installed. Same test files run under real busted too — this shim just
-- provides describe / it / assert.are.equal / assert.is_true etc.
--
--   lua tests/run.lua
...
local files = {
    ...
    "tests/tiers_test.lua",
    "tests/persist_test.lua",
    "tests/seed_bridge_test.lua",
    "tests/filter_test.lua",
    "tests/settings_bridge_test.lua",
    "tests/manifest_test.lua",
    "tests/json_test.lua",
    "tests/plateau_test.lua",
    "tests/permute_test.lua",
    "tests/spawn_derangement_test.lua",
    "tests/aggro_tag_cache_test.lua",
    "tests/spawn_swap_publish_test.lua",
    "tests/spawn_map_dump_test.lua",
    "tests/resource_map_test.lua",
    "tests/aggro_test.lua",
    "tests/recipes_test.lua",
    "tests/recipe_map_dump_test.lua",
    "tests/base_pieces_test.lua",
    "tests/resource_hook_test.lua",
    "tests/introspect_components_test.lua",
    "tests/selftest_test.lua",
    "tests/debug_bridge_test.lua",
}
